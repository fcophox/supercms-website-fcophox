...
"[project]/node_modules/google-translate-api-x/lib/defaults.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/google-translate-api-x/lib/translation/TranslationResult.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/google-translate-api-x/lib/languages.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/google-translate-api-x/lib/translation/batchTranslate.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { DEFAULT_OPTIONS, TRANSLATE_PATH } = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/defaults.cjs [app-route] (ecmascript)");
const TranslationResult = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/TranslationResult.cjs [app-route] (ecmascript)");
const { getCode } = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/languages.cjs [app-route] (ecmascript)");
module.exports = function(input, options) {
    ...
    const sourceArray = Array.isArray(input) ? input : typeof input === 'object' ? Object.values(input) : [
        input
    ];
    ...
    for(let i = 0; i < sourceArray.length; i++){
        ...
        if (fromIso === null) {
            return new Promise(()=>{
                throw new Error(`From language ${from} unsupported, bypass this with setting forceFrom to true if you're certain the iso is correct`, {
                    cause: {
                        options: {
                            from
                        }
        ...
        if (toIso === null) {
            return new Promise(()=>{
                throw new Error(`To language ${to} unsupported, bypass this with setting forceTo to true if you're certain the iso is correct`, {
                    cause: {
                        options: {
                            to
                        }
    ...
    requestOptions.body = 'f.req=' + encodeURIComponent(JSON.stringify([
        freq
    ])) + '&';
            ...
            for (let translation of chunk){
                ...
                if (translation[1][0][0][5] === undefined || translation[1][0][0][5] === null) {
                    ...
                    result.text = translation[1][0][0][5].map(function(obj) {
                        return obj[0];
                    }).filter(Boolean)// Google api seems to split text per sentences by <dot><space>
...
"[project]/node_modules/google-translate-api-x/lib/translation/singleTranslate.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/google-translate-api-x/lib/translation/translate.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { DEFAULT_OPTIONS } = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/defaults.cjs [app-route] (ecmascript)");
const batchTranslate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/batchTranslate.cjs [app-route] (ecmascript)");
const singleTranslate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/singleTranslate.cjs [app-route] (ecmascript)");
module.exports = function(input, options) {
    options = {
        ...DEFAULT_OPTIONS,
        ...options
...
"[project]/node_modules/google-translate-api-x/lib/translation/Translator.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { DEFAULT_OPTIONS } = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/defaults.cjs [app-route] (ecmascript)");
const translate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/translate.cjs [app-route] (ecmascript)");
module.exports = class {
    options;
    constructor(options){
        this.options = {
...
"[project]/node_modules/google-translate-api-x/lib/speak.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
module.exports = function(input, options) {
    ...
    for(let i = 0; i < sourceArray.length; i++){
        ...
        if (text.length > 200) {
            return new Promise(()=>{
                throw new Error('At least one of the inputs exceeded 200 characters, which is rejected by Google translate.  You should split it into a batch input with arrays/objects.', {
                    cause: {
                        input: {
                            text
                        }
...
"[project]/node_modules/google-translate-api-x/index.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const translate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/translate.cjs [app-route] (ecmascript)");
const Translator = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/Translator.cjs [app-route] (ecmascript)");
const singleTranslate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/singleTranslate.cjs [app-route] (ecmascript)");
const batchTranslate = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/translation/batchTranslate.cjs [app-route] (ecmascript)");
const { langs, isSupported, getCode } = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/languages.cjs [app-route] (ecmascript)");
const speak = __turbopack_context__.r("[project]/node_modules/google-translate-api-x/lib/speak.cjs [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_c117f682._.js.map