...
"[project]/src/app/blog/BlogClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BlogClient() {
    const { t, language } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LanguageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLanguage"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePageTitle$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePageTitle"])("nav.blog");
    ...
    const fetchArticles = async ()=>{
        setIsLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('articles').select('*').eq('status', 'published') // Only show published articles
        .order('published_at', {
            ascending: false
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c0160a4._.js.map