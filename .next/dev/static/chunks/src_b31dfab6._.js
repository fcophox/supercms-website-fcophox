...
_s(ArticleLikeSection, "lTrboTgpFc4x7KWy4aLLs7naQJ8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
function BlogPostClient() {
    ...
    const fetchArticle = async (slugStr)=>{
        setIsLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('articles').select('*').or(`slug.eq.${slugStr},slug_en.eq.${slugStr}`).eq('status', 'published').single();
        if (error) {
...
_s(BlogPostClient, "C8PiQf5QWfSbfQqajTOAY2Hlu5g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$LanguageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
...
//# sourceMappingURL=src_b31dfab6._.js.map