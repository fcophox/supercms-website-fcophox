...
const translations: Record<string, Record<Language, string>> = {
    ...
    "contact.form.type.message": { es: "Hablemos por mensaje", en: "Let's talk by message" },
    "contact.form.type.consulting": { es: "Generemos una consultoría UX", en: "Let's generate a UX Consulting" },
    "contact.form.type.diagnostic": { es: "Agendemos una reunión virtual", en: "Let's schedule a virtual meeting" },
    ...
    "contact.form.help.message": { es: "Cuéntame en qué estás trabajando hoy, en que puedo apoyarte o qué necesitas potenciar.", en: "Tell me what you are working on today, how I can support you, or what you need to boost." },
    "contact.form.help.consulting": { es: "Revisemos tu producto digital y generemos una Roadmaps para optimizar tu negocio.", en: "Let's review your digital product and generate a roadmap to optimize your business." },
    "contact.form.help.diagnostic": { es: " Un cafe virtual, agenda un horario disponible y hablemos con calma sobre lo que necesitas.", en: "A virtual coffee, select an available time slot and let's talk virtually." },
    ...
    "contact.form.budget.desc": { es: "Actívalo si ya cuentas con una idea inicial de inversión. Solo es referencial", en: "Activate it if you already have an initial investment idea. It's just a reference" },
