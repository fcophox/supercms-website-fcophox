...
const translations: Record<string, Record<Language, string>> = {
    ...
    "contact.form.type.message": { es: "Mensaje", en: "Message" },
    "contact.form.type.consulting": { es: "Consultoría", en: "Consulting" },
    "contact.form.type.diagnostic": { es: "Diagnóstico", en: "Diagnostic" },
    ...
    "contact.form.help.message": { es: "El mensaje será revisado y se entregará una respuesta en menos de 24 horas.", en: "The message will be reviewed and a response will be delivered in less than 24 hours." },
    "contact.form.help.consulting": { es: "Un especialista en UX se pondrá en contacto en menos de 24 horas para entender el requerimiento y coordinar los próximos pasos.", en: "A UX specialist will contact you in less than 24 hours to understand the requirement and coordinate the next steps." },
    "contact.form.help.diagnostic": { es: "El equipo realizará una revisión inicial y se pondrá en contacto en menos de 48 horas con un diagnóstico preliminar.", en: "The team will conduct an initial review and contact you within 48 hours with a preliminary diagnosis." },
