        ...
        <div className="max-w-[1600px] mx-auto flex flex-col min-h-full">
            ...
            <header className="mb-8 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/case-studies" className="text-[var(--text-muted)] flex items-center text-xl p-3 rounded-full bg-white/5 hover:bg-white/10 transition-colors w-12 h-12">
                        ←
                    </Link>
                    <div>
                        <h1 className="text-xl font-light text-neutral-100 mb-1">
