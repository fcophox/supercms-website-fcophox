        ...
        <div>
            <header style={{ marginBottom: "2.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    ...
                    <p style={{ color: "var(--text-muted)" }}>Administra tu oferta de servicios.</p>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                    ...
                    <Link href="/dashboard/services/new" className="btn-primary" style={{ padding: "0.5rem 1rem", fontSize: "0.875rem" }}>
                        + Nuevo Servicio
                    </Link>
                </div>
            </header>
            ...
            {isLoading ? (
                <div style={{ color: "var(--text-muted)", textAlign: "center", padding: "4rem" }}>Cargando servicios...</div>
            ) : items.length === 0 ? (
                ...
                <div style={{
                    ...
                    {items.map((item) => (
                        <Link href={`/dashboard/services/${item.id}`} key={item.id} className="glass-panel" style={{
                            borderRadius: "12px",
                            overflow: "hidden",
                            display: "flex",
                            flexDirection: "column",
