...
export default function ArticleLikeSection({ articleId, initialLikes }: ArticleLikeSectionProps) {
    ...
    return (
        <div className="w-full max-w-[800px] mx-auto mt-16 p-8 rounded-3xl bg-[#18181b] border border-[#27272a] flex flex-col sm:flex-row items-center justify-between gap-6">

            {/* Text Content */}
            <div className="flex flex-col gap-2 text-center sm:text-left">
                <h3 className="text-white text-xl font-light m-0">
                    ¿Te parece interesante este contenido?
                </h3>
                <p className="text-[#a1a1aa] text-sm m-0 max-w-[400px]">
                    Envíanos un aplauso si te parece interesante, con tu apoyo seguimos creando contenido.
                </p>
            </div>
