...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full bg-[#09090b]/80 backdrop-blur-md border-b border-white/5">
            <div className="flex items-center justify-between px-8 py-6 max-w-[1200px] mx-auto w-full">
                {/* Logo / Brand */}
                <Link href="/" className="flex items-center gap-4 no-underline z-[60]" onClick={() => setIsMobileMenuOpen(false)}>
